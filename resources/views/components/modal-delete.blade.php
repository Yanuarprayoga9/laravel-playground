...
@props(['title', 'message', 'action', 'id', 'confirmText', 'cancelText'])
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <p class="mb-5 text-gray-500 dark:text-gray-400">{{ $message }}</p>
                <div class="flex gap-x-8 w-full justify-center">
...
<button data-modal-target="{{ $id }}" data-modal-toggle="{{ $id }}"
    class="block text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm  text-center "
    type="button">
